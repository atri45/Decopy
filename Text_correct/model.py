...
class PinyinBertEmbeddings(nn.Module):
    """add pinyin embedding based on BertEmbeddings"""
...
class PinyinBertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.embeddings = PinyinBertEmbeddings(config)
...
class PinyinBertForMaskedLM(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = PinyinBertModel(config, add_pooling_layer=False)
